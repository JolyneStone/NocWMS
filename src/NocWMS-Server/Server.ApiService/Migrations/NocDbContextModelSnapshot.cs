...
namespace Server.ApiService.Migrations
{
    ...
    partial class NocDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.ApiService.Models.Customer", b =>
                {
                    ...
                    b.HasAlternateKey("CustomerName");
            ...
            modelBuilder.Entity("Server.ApiService.Models.InboundReceiptItem", b =>
                {
                    ...
                    b.Property<string>("InboundReceiptId");
            ...
            modelBuilder.Entity("Server.ApiService.Models.InventoryCell", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("Server.ApiService.Models.OutboundReceiptItem", b =>
                {
                    ...
                    b.Property<string>("OutboundReceiptId");
            ...
            modelBuilder.Entity("Server.ApiService.Models.Warehouse", b =>
                {
                    ...
                    b.HasAlternateKey("WarehouseName");
            ...
            modelBuilder.Entity("Server.ApiService.Models.InboundReceiptItem", b =>
                {
                    ...
                    b.HasOne("Server.ApiService.Models.InboundReceipt", "InboundReceipt")
                        .WithMany("InboundReceiptItems")
                        .HasForeignKey("InboundReceiptId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Server.ApiService.Models.Inventory")
                        .WithMany("InboundReceiptItems")
            ...
            modelBuilder.Entity("Server.ApiService.Models.InventoryCell", b =>
                {
                    ...
                    b.HasOne("Server.ApiService.Models.Product")
                        .WithMany("InventoryCells")
                        .HasForeignKey("ProductId");
                });
            ...
            modelBuilder.Entity("Server.ApiService.Models.OutboundReceiptItem", b =>
                {
                    ...
                    b.HasOne("Server.ApiService.Models.OutboundReceipt", "OutboundReceipt")
                        .WithMany("OutboundReceiptItems")

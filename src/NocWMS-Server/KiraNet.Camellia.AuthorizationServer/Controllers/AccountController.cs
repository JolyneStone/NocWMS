...
using KiraNet.Camellia.AuthorizationServer.Quickstart.Account;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Logon verification failed, please try again.");
                    return View(model);
                }
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailConfirmationAsync(model.Email, user.UserName, callbackUrl);
        ...
        [HttpGet]
        [Authorize(ApiAuthorizationPolicy.PolicyAdminWithRole)]
        ...
        public async Task<IActionResult> AddUser(AddUserViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Added a user!.");
                    return RedirectToAction("AddUser", "Account", new { successfulMsg = "Add user succeeded, please continue to add or return" });
                }
                AddErrors(result);
            }
        ...
        public async Task<IActionResult> DeleteUser(string id, bool? saveChangesError = false)
        {
            ...
            {
                var msg = "Failed to delete user, account 'admin' cannot be deleted";
            ...
            if (!result.Succeeded)
            {
                var msg = $"Failed to delete user, username: {user.UserName}";
                _logger.LogError(msg);
                ViewData["ErrorMessage"] = msg;
            ...
            var successfulMsg = "Delete Succeeded";
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                if (info == null)
                {
                    throw new ApplicationException("Error loading external Loginformation during confirmation.");
                }
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailResetPasswordAsync(model.Email, user.UserName, callbackUrl);
                return RedirectToAction(nameof(ForgotPasswordConfirmation));
            }
